...
//         create.setBackground(new Color(133, 193, 233));
         ...
         create.setFont(new Font("Thahoma",Font.BOLD,14));
         ...
         back.setFont(new Font("Thahoma",Font.BOLD,14));
    ...
    @Override
        ...
        if(ae.getSource()==create){
            ...
            String query = "insert account values ('"+username+"','"+name+"','"+password+"', '"+question+"', '"+answer+"')";
            try{
                Conn c = new Conn();
